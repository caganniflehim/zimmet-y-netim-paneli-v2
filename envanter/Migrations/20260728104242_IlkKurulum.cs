        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarkaModel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    Durum = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, defaultValue: "depoda")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__cihazlar__B560B487DCBEF0DE", x => x.CihazID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Durum = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, defaultValue: "Aktif")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Personel__0F0C5751F34836ED", x => x.PersonelID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__zimmet__B89A48E1BAEE53AF", x => x.ZimmetID);
                    table.ForeignKey(
                        name: "FK__zimmet__CihazID__0B91BA14",
                        column: x => x.CihazID,
                        principalTable: "cihazlar",
                        principalColumn: "CihazID");
                    table.ForeignKey(
                        name: "FK__zimmet__Personel__0C85DE4D",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__cihazlar__1A24D142C838711C",
                table: "cihazlar",
                column: "SeriNo",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_zimmet_CihazID",
                table: "zimmet",
                column: "CihazID");
